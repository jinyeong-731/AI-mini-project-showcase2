...
class CNN(nn.Module):
    ...
    def forward(self, x):
        # TODO 1-C — features의 출력을 classifier로 전달해 반환하세요.
...
def load_model():
    ...
    model = CNN(
        conv1=model_config["conv1"],
        conv2=model_config["conv2"],
